...
public class SndInstance extends SignalDispatcher {
    ...
    //
    //==================================
    public function reset(id:String, sound:Sound):SndInstance {
        if(id == null)
    ...
    public function play(volume:Number, pan:Number, loops:int, startTime:Number):SndInstance {
        ...
        _channel = _sound.play(startTime, _loopsLeft, transform);
        _channel.addEventListener(Event.SOUND_COMPLETE, onSoundComplete);
        return this;
    }

    public function pause():SndInstance {
        _isPlaying = false;
    ...
    public function resume():SndInstance {
        _isPlaying = true;
        if(_channel != null)
            _channel.removeEventListener(Event.SOUND_COMPLETE, onSoundComplete);
    ...
    public function mute():SndInstance {
        _isMuted = true;
        transform.volume = 0;
    ...
    public function unMute():SndInstance {
        _isMuted = _volume == 0;
